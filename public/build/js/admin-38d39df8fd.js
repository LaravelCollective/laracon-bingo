...
},{"./components/NavBar.vue":15,"vue":6,"vue-hot-reload-api":3,"vueify/lib/insert-css":7}],9:[function(require,module,exports){
'use strict';
...
var _class = function () {
    function _class() {
        ...
        // Configure Stuff
        _vue2.default.http.options.root = window.Delivvrator ? window.Delivvrator.root : null;

        // Create Router
        this.router = new _vueRouter2.default({});
        this.routing = false;
    }
    ...
    _createClass(_class, [{
        ...
        value: function root(_root) {
            _vue2.default.http.options.root = _root;
        ...
        value: function headers(_headers) {
            _vue2.default.http.headers.common = _headers;
        ...
        key: 'redirects',
        value: function redirects(_redirects) {
            this.router.redirect(_redirects);
            this.routing = true;
        ...
        value: function start(target) {
            if (this.routing) this.router.start(this.app, target);else new _vue2.default(this.app).$mount(target);
        }
    }]);
...
},{"vue":6,"vue-resource":4,"vue-router":5}],10:[function(require,module,exports){
'use strict';
...
var _Terms = require('./admin/Terms.vue');

var _Terms2 = _interopRequireDefault(_Terms);

var _Users = require('./admin/Users.vue');

var _Users2 = _interopRequireDefault(_Users);

var _User = require('./admin/User.vue');
...
}).app(_Admin2.default).start('#admin');

},{"./Admin.vue":8,"./SPA":9,"./admin/Terms.vue":11,"./admin/User.vue":12,"./admin/Users.vue":13}],11:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-383afa2e", module.exports)
  } else {
    hotAPI.update("_v-383afa2e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    methods: {
        reload: function reload() {
            ...
            this.$http.get('/api/users/' + this.$route.params.user).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4a9aa54e", module.exports)
  } else {
    hotAPI.update("_v-4a9aa54e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/Bingo.vue":14,"vue":6,"vue-hot-reload-api":3}],13:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7f4e9eea", module.exports)
  } else {
    hotAPI.update("_v-7f4e9eea", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./Term.vue":16,"vue":6,"vue-hot-reload-api":3,"vueify/lib/insert-css":7}],15:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.navbar-brand>img {\n    max-height: 24px;\n}\n")
"use strict";
...
},{"vue":6,"vue-hot-reload-api":3,"vueify/lib/insert-css":7}]},{},[10]);
